...
personal_homedir = '/home/alex/Documents/'
picklefile = personal_homedir + 'global_superclustering/Project/source/synthetic_cat.p'
pkl_file = open(picklefile,'rb')
mixture = pickle.load(pkl_file)
pkl_file.close()  

#Get initial clustering for testing
initpicklefile = personal_homedir + 'global_superclustering/Project/source/init_synthetic_cat_4.p'
